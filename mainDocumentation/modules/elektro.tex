...
Ein niederohmige Widerstand wird verwendet, um einen ausreichend hohen Zenerstrom zu generieren, um den SCR zu zünden.
Der Kondensator hat die Funktion, die Aktiverung des Crowbar-Schaltung durch harmlose Spannungsspitzen zu negieren.
...
Die resultierende Schwingungen führen zu Störungen in der Versorgung, welche die Crowbar-Schaltung jedoch nicht auslösen sollen.
Aus diesen Gründen heraus sollte die Crowbar-Auslösespannung nicht unter 6V gewählt werden, jedoch sollte sie auch nicht über 7V gewählt werden,
...
Eingehende Information soll über den vorgesehenen Mikrocontroller verarbeiten werden und Prozesse über diesen Ausgeführt werden. \\

Mit diesen Anforderungen wurde ein Schaltplan erstellt und eine Platine geplant, entworfen, gefertigt und bestückt.
Über ausführliches Testen wurden Fehlerquellen und einzelne Mängel ausgemerzt, sodass ein funktionstüchtiger Prototyp zu Stande kam.\\
...
Das durch diese Arbeit erlangte Fachwissen in verschiedenen Softwareprodukten, in Schaltungsdimensionierungen allgemein sowie in der Praxis gemachten Fehlern erachtet der Autor als essenziell für die Zukunft.

...
von der Spannungsversorgung zur Verfügung gestelltem Strom, durch. Jedoch entsteht die negative Tatsache einer verpolten Spannung von bis zu 1V, bis die Sicherung auslöst.
...
Der P-Kanal MOSFET leitet, wenn das Gate um U_{GSth} negativer ist als der Spannungspegel anliegend am Source.
Das Anlegen einer korrekt gepolten Spannung am Eingang des MOSFET bewirkt ein Leiten der Bulk-Diode, sodass
am Sourceeingang die Eingangsspannung ankommt. Weil die am Source anliegende Spannung weitaus psoitiver als
U_{GSth}, leitet der MOSFET. Die Tatsache, dass der MOSFET quasi verkehrt herum leitet und der Drain somit
positiver als der Source ist, gilt als redondant, da es sich lediglich um einige Millivolt handelt.
Sollte man eine verpolte Spannung am Eingang anlegen, sperrt die Bulk-Diode und der MOSFET gelangt nicht in den leitenden
Zustand.
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        ...
        \draw (2.6,4) to [short, *-](2.6,4.3) to [/tikz/circuitikz/bipoles/length=0.5cm,D](3.4,4.3) to [short,-*](3.4,4){};
...
\subsubsection{Varianten des Ein-/Ausschaltens}

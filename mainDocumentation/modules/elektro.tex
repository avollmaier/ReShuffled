...
Er verfügt über 32 I/O Register, eine SPI Schnittstelle, eine I²C Schnittstelle, zwei UART Schnittstellen und drei flexible Timer.
...
Mithilfe des Timer 0 wird am Ausgang OC1B des Mikrocontrollers ein PWM-Signal erzeugt, unter Verwendung dessen, abhängig vom gewählten Duty-Cycle, Spannungssignale in gewissen Zeitabständen geschickt werden.
...
Das Echo wird vom Sensor wieder aufgenommen und über die Zeitspanne zwischen dem Zeitpunkt des Absendens und dem Zeitpunkt des Erfassens wird der Abstand vom Sensor berechnet.
...
Als diese Dioden selektierten wir die RR264M, welche einen Strom von 1A treiben können, was wichtig für die Implemntierung an den induktiven Lasten ist.

...
Dieser Mikrochip besitzt einen Flash-Speicher von 16kiB, einen \acs{SRAM} in einer Größe von 1kiB und einen \acs{EEPROM}-Speicher von 512 Bytes.
Der ATmega162 verfügt über eine SPI und zwei UART Schnittstellen sowie 35 \acs{I/O} Register und zwei Timer.
...
Mithilfe des Timer 0 wird am Ausgang OC1B des \acs{µC} ein PWM-Signal erzeugt, unter Verwendung dessen, abhängig vom gewählten Duty-Cycle, Spannungssignale in gewissen Zeitabständen geschickt werden.
Dadurch befindet sich jeweils an einem Eingang des UND-Gatters mit der Bezeichnung IC1 und an einem Eingang des UND-Gatters mit der Bezeichnung \acs{I2C} ein Signal mit einem HIGH-Pegel (Spannung) oder
...
\begin{table}[htbp]
    ...
    >{\columncolor[HTML]{FFFFFF}}l |}
        \hline
        & \textbf{Doppel-Schaltnetzteil} & \textbf{\acs{SN} und Schaltregler} & \textbf{SN und Festspannungsregler} \\ \hline
...
\subsubsection{Verpolungsschutz mithilfe eines P-Kanal \acs{MOSFET}\footfullcite{Verpolschutz}}
...
\subsubsection{Andere Variante \footfullcite{EEVblog-262-Worlds-Simplest-Soft-Latching-Power-Switch-Circuit}}
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        ...
        \draw (0,4.8) -- node[left] {$U_\mathrm{e}$}node[sloped,currarrow,pos=1] {}(0,0.2);
...
\subsection{Beschaltung des ATmega324P\footfullcite{Datasheet-ATmega324P}}
...
\subsection{DRV8825-Schrittmotortreiber\footfullcite{DRV8825-Datasheet}}
...
\subsubsection{Crowbar Circuit\footfullcite{@TheArtOfElectronics-Kapitel-9.13.1-OvervoltageCrowbars}}

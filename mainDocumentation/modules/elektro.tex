...
\begin{figure}[hpt]
    ...
    \begin{circuitikz}[european, scale = 1]
        ...
        \draw (2.9,2.5)node[anchor=above]{560};
        \draw (1,3) to [short,*-](1,3) to [R, l_=$R2$](1,0) to [short,-*](5,0) to (5,-0.5);
        \draw (2,1.5)node[anchor=above]{10k};
...
\begin{figure}[hpt]
    ...
    \begin{circuitikz}[european, scale = 0.8]
        ...
        \draw (5,3) to (5,0);
        \draw (4.1,3) to (3.5,3) to [R, l_= $R1$](1.5,3) to [short, -o](-0.5,3);
        \draw (3.1,2.4)node[anchor=above]{560};
        \draw (1,3) to [short,*-](1,3) to [R, l_=$R2$](1,0) to [short,-*](5,0) to (5,-0.5);
        \draw (2.3,1.5)node[anchor=above]{10k};
        \draw (5,3)node[nfet, solderdot, bodydiode](nfet){};
        \draw (nfet.G) node[above]{G};
        \draw (nfet.D) node[left]{D};
        \draw (nfet.S) node[left]{S};
        ...
        \draw (15,3) to (15,0);
        \draw (14.1,3) to (13.5,3) to [R, l_= $R1$](11.5,3) to [short, -o](9.5,3);
        \draw (13.1,2.4)node[anchor=above]{560};
        \draw (11,3) to [short,*-](11,3) to [R, l_=$R2$](11,0) to [short,-*](15,0) to (15,-0.5);
        \draw (12.3,1.5)node[anchor=above]{10k};
...
Aus diesem Grunde heraus steigt auch der Widerstand des Thermistors, weshalb dieser den Strom begrenz und der Strom somit auf ein Minimum zurückfällt.
...
\begin{itemize}
    ...
    \item D1 als SMBJ5.0A
\end{itemize}

Die wiederverwendbare Sicherung MF-MSMF200 hält eine maximale Spannung von 8V und einem Haltestrom von 2A bei 23°C aus.
...
Die Suppressordiode SMBJ5.0A bringt eine Breakdown Voltage von mindestens 6.4V bis 7V mit sich und kann einen maximalen Spitzenstrom von bis zu 65.3A bei einer Clamping Voltage von 9.

Eine weitere, zerstörerische und wartungsintensivere Möglichkeit wäre, diese Schaltung mit einer Schmelzsicherung anstatt dem PTC zu realisieren.

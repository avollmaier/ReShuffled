...
Der von uns ausgewählte MOSFET FDN337 verfügt über das Attribut einer maximalen Threshold-Voltage von 3V .
Aufgrund dessen sollte auch nach einer Zeit 2 Sekunden ein Potential von größer gleich 3V am Gate der Halbleiterkompontente anliegen.
...
Wert des Widerstands R2 bei einem Spannungs-Sollwert von 3V nach 2 Sekunden wie folgt:
...
\begin{align*}
    ...
    R &= -\frac{2s}{ln(\frac{3V}{3.078592V}) \cdot 100\muF} \\
    R &=  763803.3\Omega
\end{align*}

Dieses Ergebnis macht deutlich, dass es bei derartigen Bedingungen einen Widerstand auszuwählen, dessen Wert 763803.3 Ohm übersteigt.
Diese Erkenntnis brachte uns zu der Entscheidung, einen Widerstand in der Höhe von 1 MOhm auszuwählen.

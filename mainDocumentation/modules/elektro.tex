...
Weitere Kriterien, die unsere Wahl befürworteten, waren die niedrige Anzahl von nur vier Bauteilen, der hohe maximale Ausgangsstrom sowie die hohe Effizients. \\
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        ...
        \draw (6.5,0) to [sD, l_=$D1$, *-*](6.5,5) to (6.5,0);
        \draw (3,4) to (3,6) to (5.5,6) to (5.5,4) to (3,4);
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        ...
        %Mini-USB
        \draw (0,1) to (0,3.5) to (2,3.5) to (2,1) to (0,1);
        \draw (2,3) to (2.5,3) to [sD, l_=$D1$](2.5,6) to (2.5,3);
        \draw (2,2.5) to (2.5,2.5);
        \draw (2,2) to (2.5,2);
        \draw (2,1.5) to (2.5,1.5);
        \draw (2.6,1.6) to (2.4,1.4);
        \draw (2.6,1.4) to (2.4,1.6);

        %USB to UART - Modul
        \draw (5,0) to (8,0) to (8,4.5) to (5,4.5) to (5,0);

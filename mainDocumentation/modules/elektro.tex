...
Um eine Dimensionierung der Widerstände und des Kondensators vorzunehmen, wird Gebrauch von LaPlace-Transformationsformeln und den grundlegenden Formeln der Elektrotechnik gemacht:
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        \draw (1.5,2) to [R, l=$R1$](2.5,2);
        \draw (2.5,2) to (3.5,2) to [eC, l=$C1$, *-*](3.5,0);
...
erhält man aufgrund des Maschengleichungsgesetzes folgende Formel:

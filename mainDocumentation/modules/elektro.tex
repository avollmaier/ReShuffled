...
\subsubsection{Andere Varianten}

Die folgenden Varianten kamen ebenfalls im Laufe der Diplomarbeit auf.
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.2]
        ...
        \draw (3,0) to (2,0) node[ground]{};
        \draw (5,4) to [short, o-o](5,4)to(5,3.9) node[ground]{};
...
Die Eingangsspannung von 12V, welche vom Netzteil zur Verfügung gestellt werden, werden durch eine Betätigung von S\textsubscript{1} durchgeschaltet.

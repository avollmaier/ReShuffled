...
\begin{figure}[hpt]
    ...
    \begin{circuitikz}[european, scale = 0.7]
        ...
        \draw (0,2) to [/tikz/circuitikz/bipoles/length=1cm, D, l=$D1$](0,0);
        \draw (0,4.5) to [R, l = $R1$](0,2.5) to (0,2);
    ...
    \end{circuitikz}
    \caption{Erfassung der Schrittmotorpsoition}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{circuitikz}[european, scale = 1.15]
        ...
        %Mini-USB
        \draw (-1,1) to (-1,3.5) to (1,3.5) to (1,1) to (-1,1);

...
\begin{figure}[ht]
    ...
    \begin{circuitikz}{european, scale = 1}
        ...
        \draw (5,1.5) to [short,-o](4,1.5)node[anchor=east]{SLEEP};
        \draw (5,2) to [short,-o](4,2)node[anchor=east]{RESET};
        ...
        \draw (5,4) to [short,-o](4,4)node[anchor=east]{EN};

        \draw (8,0.5) to (9, 0.5) to (9,0)node[rground]{};
        \draw (8,1) to (8.5, 1);
        \draw (8.4,1.1) to (8.6,0.9);
        \draw (8.4,0.9) to (8.6,1.1);

...
Die Ansteuerlogik dieses Moduls gestaltet sich über binäre Spannungspegel.\footfullcite{A4988-Stepper-Motor-Driver-Carrier}

\subsubsection{DRV8825}
Diesem Treiber-Board von Texas Instruments ist es möglich, mit einer Spannung von 8.2V bis 45V zu arbeiten.
...
sodass er in vielen Anwendungen als leistungsstärkerer Ersatz verwendet werden kann.\footfullcite{DRV8825-Stepper-Motor-Driver-Carrier-High-Current}
...
Das Gewicht von 200g und eine Größe von 57mm x 96mm x 28mm unterscheiden sich wesentlich von den anderen Treibermodulen.\footfullcite{TB6600-Arduino-Stepper-Motor-Driver}
...
Es sind große Erkennungsabstände möglich.\footfullcite{Induktiv-Kapazitiv-Optisch-oder-Ultraschall}
...
Ein fast wartungsfreier Betrieb ist möglich.\footfullcite{Induktiv-Kapazitiv-Optisch-oder-Ultraschall}
...
Für hohe Schaltabstände sind leitende und geerdete Gegenstände von Vorteil.\footfullcite{Funktionsweise-und-Technologie-von-kapazitiven-Sensoren}
...
\begin{table}[htbp]
    ...
    >{\columncolor[HTML]{FFFFFF}}l |}
        \hline
        & \textbf{Doppel-Schaltnetzteil} & \textbf{\acs{SN} und Schaltregler} & \textbf{SN und Schaltregler} \\ \hline
...
\subsubsection{Verpolungsschutz mit einer Schottky-Diode\footfullcite{Verpolschutz}}
...
\subsubsection{Verpolungsschutz mit einer Sicherung und einer Schottky-Diode\footfullcite{Verpolschutz}}
...
Über den Data-Terminal-Ready Pin des USB-UART-Converters und dessen Jumper-Pad oder die ISP-Schnittstelle ist es jedoch ebenfalls möglich, den ATmega324P zu resetten.
...
\subsubsection{Datenblattwerte\footfullcite{DRV8825-Datasheet}}
...
\subsubsection{Beschaltungs- und Anschlussfunktionen\footfullcite{DRV8825-Datasheet}}
...
\newpage
\subsubsection{Schrittauflösung\footfullcite{DRV8825-Datasheet}}
...
Um den durch die Motorwindungen fließenden Strom zu limitieren, kann dem Datenblatt des DRV8825 folgende Formel entnommen werden:\footnotemark[16]
...
Da die Schaltschwelle der I/O Pins des ATmega324P bei LOW-Pegeln maximal 0.99V und die bei HIGH-Pegeln mindestens 1.98V beträgt, wurden diese gemessenen Werte als zulässige bewertet.
...
Als USB-zu-UART-Converter wählten wir den CH340G aus, für dessen Wahl seine geringe Kosten, die kleine Gehäusebauform sowie ein Treiber im Linux-Kernel sprach.
...
\begin{figure}[hbt]
    \centering
    \includegraphics[scale=0.29]{fig/elektro/TopLayer.png}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[scale=0.29]{fig/elektro/BotLayer.png}
...
\begin{figure}[hb]
    \includegraphics[scale=0.25]{fig/elektro/3DTop.jpg}
    \caption{3D-Ansicht des Top-Layer}
\end{figure}

\begin{figure}[hb]
    \includegraphics[scale=0.25]{fig/elektro/3DBot.jpg}

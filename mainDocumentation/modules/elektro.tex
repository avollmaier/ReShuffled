...
\subsubsection{ATmega162}\footfullcite{AVR Typen}
...
\subsubsection{ATmega324P}\footnotemark[1]
...
\subsubsection{ATmega128}\footnotemark[1]
...
Um die Notwendigkeit eines Kühlkörpers zu berechnen, werden Formeln der Datenblätter zur Berechnung angewandt.\footfullcite{LM2576 Datasheet}
...
Eine essenzeille Schutzmaßnahme, um den Raspberry Pi bei einer zugeführten Überspannung nicht zu beschädigen, wäre ein sogenannter Crowbar-Circuit.

...
Um das Zeitfenster der Projekts nicht zu verzögern werden folgende Meilensteine in den Zeitplan implementiert:
\begin{enumerate}
...
Trotz dieser Vorteile kristallisierte sich jedoch Netbeans heraus und wird im
...
Um die Übersichtlichkeit des Projektes zu verbessern wird nach einer klar definierten Projektstruktur gearbeitet.
Das bedeutet das jede Klasse, die neu erstellt wird, ein Teil der Struktur ist und innerhalb dieser platziert wird.
...
\end{figure}
Im Allgemeinen bringt diese Aufteilung 2 fundamentale Vorteile mit sich:
\begin{enumerate}
    \item \textbf{Bessere Übersichtlichkeit} \\
    Um eine Erweiterung von außen ohne Probleme sicherzustellen, ist es wichtig, der Übersichtlichkeit des Projekts nicht zu schaden.
    \item \textbf{Vermeidung von chaotischer Strukturierung}\\
    Selbst wenn keine Person von außen eine Änderung am Programm vorsieht, hilft es dem Entwickler, eine klare Definition seiner Strukturierung zu haben.
\end{enumerate}

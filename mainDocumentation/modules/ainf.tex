...
Folglich werden am Schluss der Verlauf der \textbf{Testing-Phase} sowie die Zusammensetzung des \textbf{Teilaufbaus} dokumentiert.
...
\scalebox{0.57}{
        ...
        link/.style={->, thick}
            ...
            \ganttlink[link mid=0.75]{KonzeptplanungBack}{Start-ProgrammierungBack}
            \ganttlink{Einrichtung - Arbeitsumgebung}{Start-ProgrammierungBack}
        \end{ganttchart}
}
...
\section{Anforderungen und Ziele}\label{subsec:gesamtanforderungen-und-ziele}

\subsection{Fronted-Programmierung}
Im Allgemeinen besteht das Ziel darin, eine benutzerfreundlich grafische Bedienoberfläche zu realisieren, welche schlussendlich im Betrieb der Maschiene auf einem 7" Display angezeigt werden soll. Auf diesem Interface soll es möglich sein, die Steuerung der Maschiene zu übernehmen.
...
Die wesentliche Anforderung, die Oberfläche einfach und schlicht zu halten, soll im Projekt berücksichtigt werden. Grundsätzlich steht die User Experience sowie die Funktionalität bei der Programmierung im Vordergrund!
...
\subsubsection{Material-Design-Bibliothek-JFoenix}

...
\lstinputlisting[firstline=142, lastline=176, style=c,caption=Funktion app_handleUartByte(),label=multiLang]{src/app.c}
Zuerst wird geprüft ob das erste ankommende Byte ein Startbyte nämlich ein ":" ist.

...
Ziel ist es also, diese serielle Kommunikation auf dem Mikrocontroller zu programmieren.
...
\end{figure}\\
Der Kopf dieser Struktur ist der Ordner mit dem Namen des Projekts.
...
Dabei erleichtert diese Verzeichnishierachie die übersichtlichkeit aller verwendeten Bibliotheken und dessen Versionen.
\\\\
...
Das zuvor genannte Layout der Projekthierachie eignet sich gut für viele Projekte.
Jedoch zeigen sich nach und nach einige Schwachstellen an diesem System.

Einerseits ist das aufwendige Erstellen dieser Hierachie ein Punkt, welcher nicht unerwähnt bleiben soll.
...
Grund dafür ist wiederum die fehlende Möglichkeit, Remote-Debugging durchzuführen.
...
Singelton dient dazu, die Einzigartigkeit eines Objekts sicherzustellen.
Das bedeutet eine Instanz des Objektes ist nur genau einmal im Speicher vorhanden.
Auch wird ein zentraler Zugriffspunkt innerhalb des Programms geschaffen.

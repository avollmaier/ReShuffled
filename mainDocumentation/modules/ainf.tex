...
Realisiert wird diese Verbindung, wie bereits im \autoref{serialSim} beschrieben, mithilfe von Input- und Outputstreams.
Also werden diese zu Beginn definiert.\\
Um nun den Serial-Simulator zu starten ist ledeglich eine Erstellung des ReshuffledMainboardSimulator notwendig.
...
Nun kann mithilfe der Methode \lstinline{serialPort.openPort()} der Port geöffnet werden.\\\\
Dieses genannte "Öffnen" des Ports kann unter gewissen Umständen zu folgenden Fehlern führen:\footfullcite{scream3r2020}

...
\subsection{Auswahl der Arbeitsumgebung}
...
\subsection{Projektorganisation}\label{sec:projektorganisation}
...
\textbf{Bibliotheken}
\\
Oft werden externe Bibliotheken verwendet, welche im Ordner \lstinline{lib} gesammtelt werden.
...
\\
In unserem Fall ist es auch notwendig, einen Ordner explizit für Konfigurationsdateien vorzusehen. Dort können Textresourcen für Sprachvarianten und Konfigurationsdateien für etwaige Aufgaben abgelegt werden.
...
Singelton dient dazu, die Einzigartikeit eines Objekts sicherzustellen.

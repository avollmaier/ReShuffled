...
\begin{wrapfigure}{r}{8 cm}
    \includegraphics[width=8 cm]{fig/mech/StopperOben}
...
\begin{wrapfigure}{r}{10 cm}
    ...
    \includegraphics[width=8 cm]{fig/mech/FührungPLAUntenRechts}
...
\begin{wrapfigure}{r}{8 cm}
    ...
    \includegraphics[width=8 cm]{fig/mech/Winkel}
...
\begin{wrapfigure}{r}{8 cm}
    ...
    \includegraphics[width=8 cm]{fig/mech/WinkelSensor}
...
des Gehäusematerials kamen diverse Materialien infrage\footfullcite{fibox.ch2020}:
...
\begin{wrapfigure}{H}{5.5cm}
    \includegraphics[scale=0.5,page=1]{fig/mech/Gehäuse.png}
...
Um die Winkelbeschleunigung $\alpha$ zu berechnen, wird die Winkelgeschwindigkeit $\omega$ benötigt\footfullcite{Grund-Wissen.de2018}.

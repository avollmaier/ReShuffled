...
\begin{figure}[H]
    \centering
    \includegraphics[width=8 cm]{fig/mech/Sensorhalterung neu}
...
\begin{wrapfigure}{r}{8 cm}
    \includegraphics[width=8 cm]{fig/mech/AufhängungHubmahgnet}
...
\begin{wrapfigure}{r}{8cm}
    \includegraphics[width=8 cm]{fig/mech/AufhängerIUnten}
...
\begin{wrapfigure}{R}{6 cm}
    \includegraphics[width=6 cm]{fig/mech/FührungPLAUntenRechts}
...
Die Kartenentnahme, die in  zu erkennen ist, befindet sich am unteren Ende der Maschine, sie dient dazu die Karten zwischenzulagern bis der Spieler
...
\begin{figure}[H]
    \centering
    \includegraphics[scale =0.5]{fig/mech/Ausgabefach}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8 cm]{fig/mech/SensorStütze}
    \caption{Sensorhalterung}
...
\footfullcite[vgl.][]{fibox.ch2020}Das Gehäuse soll bei dieser Maschine optisch ansprechen und so klein wie möglich gehalten werden. Für die Auswahl
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2,page=1]{fig/mech/Gehäuse.png}
    \caption{Gehäuse}
\end{figure}
...
\textbf{Satz von Steiner:\footfullcite{Maschinenbau-Wissen.de2009a}}\\
...
\footfullcite{Grund-Wissen.de2018}Um die Winkelbeschleunigung $\alpha$ zu berechnen, wird die Winkelgeschwindigkeit $\omega$ benötigt.
...
\footfullcite{schmalz.com2020}Die theoretische Haltekraft wird mit folgender Formel berechnet:
\begin{align*}
...
\footfullcite{Wittel2013}Beim Kartenhalterunsmodul-oben wird die Kartenführung Modul 1 oben mit dem Kartenhalterunsmodul 1 verklebt.
...
Der Wert $\sigma_{K}$ ist aus der Tabelle 5-3 im Tabellenbuch \footfullcite{Wittel2013Tab} auszulesen.
...
A_{K} &= 50 mm^{2}\\
\end{align*}
\footfullcite{Grund-Wissen.de2018}Die Größte zu übertragende Kraft tritt dann ein, wenn dar ganze Kartenstapel mit 20 Karten aus dem
...
\footfullcite{Maschinenbau-Wissen.de2009} \footfullcite{ Lernhelfer.de2020}Anfangs stellte sich die Frage mit welchem Werkstoff die Prototypen sowie die Fertigen Bauteile der
...
\subsection{3D-Druck}
\footfullcite{3DRUCK.com2020} Das Verfahren des 3D-Drucks wurde aufgrund seiner preisgünstigen Fertigung, seiner Schnelligkeit und der Tatsache
...
\footfullcite{3DRUCK.com2020a} Produktionsverfahren lassen sich in 4 Kategorien einteilen:
\begin{itemize}
...
\ffotfullcite{3DRUCK.com2020} Beim 3D-Druck gibt es eine Vielzahl an Materialien mit der man arbeiten kann, im folgenden Abschnitt werden die

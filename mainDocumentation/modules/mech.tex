...
Vakuum und Druck die gewünschte From bringt.
Es gibt noch diverse andere Arten der Extruder, wie den Schneckenextruder, dieser lässt sich weiterunterteilen in den
Einschnecken-, gegenlaf Doppelschnecken- und gleichläufige Doppelschneckenextruder. Der Vortel der Doppelschneckenextruder
liegt dabei in ihrem guten Mischungsverhältniss, jedoch sind Einschneckenextruder um vieles günnstiger.
...
wird danach durch die rotierende Bewegund der Schnecke geschmolzen und nach vorne befördert. Das geschmolzene Material
staut sich an der Spitzte da das Werkzeug durch die Schließeinheit noch nicht geöffnet wurde und somit entsteht ein
...
Materia in die gewünschte Form gepritzt werden Kann.
...
Über das Kalandrieren werden Platten oder Folien hergestellt, man kann aber auchh anere Materialien wie Metalle, Papier
...
Schweißen ist das zweite Fügeverfahren für Kusntstoffe, bei diesem Verfahren muss das Material in erster Linie die
...
Der 3D-Druck ist zwar kein Umformverfahren oder Fügeverfahren, jedoch kann mit dadurch schnell und mit hoher genauigkeit Kunststoffteile
...
asugewählt, dass uns de 3D-Drucker der HTBLA Kaindrorf zur Verfügung stand.
\subsubsection{Grundlagen\footfullcite{3- Druck Grundlagen}}
...
\begin{itemize}
    \item \textbf{manuelle Verfahren}: Dieses Verfahren beschreibt vereinfacht egsagt die klasische #handarbeit, wie zum Beispiel das Biegen eines Drahtes (formend), das Hobeln von Holz (subtraktiv) oder das Auftragen von einem Guss (Additiv).
    ...
    \item \textbf{elektrische Verfahren}: Beim elektrischen Verfahren wird die Kraftwirkung mithilfe vonelektrischen Strom erzeugt. Ein Beispiel dafür wäre der Schmelzuguss, da die Schmelztemperatur dabei von einem elektrisch angetriebenen Heizsystem generiert wird.
...
als Grundlage für den 3D-Druck verwendet. Ein solcher Drucker besitzt mehrerer Druckköüfe, diese fungieren ähnlich wie
...
aufgetragen. Danach wird eine dünne Schicht Pulver über das erste Layer gezogen und der Vorgang wiederholt sich mit dem

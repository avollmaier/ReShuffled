...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \textbf{ACRYLNITRIL-BUTADIEN-STYROL (\acs{ABS})}    & \begin{tabular}[c]{@{}c@{}}Geringes Gewicht\\ Günstiger als PC\end{tabular}                                                                        & \begin{tabular}[c]{@{}c@{}}Nicht für die Verwendung im Freien\\ nicht transparent\end{tabular}        \\ \hline
        \textbf{GLASFASERVERSTÄRKTES POLYESTER (\acs{GRP})} & \begin{tabular}[c]{@{}c@{}}Wetterbeständig\\ Stabil\\ Schlagfestig\end{tabular}                                                                    & \begin{tabular}[c]{@{}c@{}}Teurer als PC\\ schwer zu bearbeiten\\ beträchtliches Gewicht\end{tabular} \\ \hline
    \end{tabular}}
...
Für die Kraft werden 50N angenommen, dies entspricht in etwa der Gewichtskraft von 5,1kg
...
Die Klebefläche schließt sich aus zwei Teilen zusammen, da das Bauteil zwei dieser Klebeflächen besitzt.
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.1,page=1]{fig/mech/GesamtsystemMech.png}

...
\subsubsection{Weitere Variantenvergleiche}
Da bei den ersten beiden Konzepten Ausgaberäder vorkommen, gibt es für diese auch verschiedene Konzepte.
Außerdem wird für diese Konzepte ein Klemmmechanissmus für das Kartenpack benötigt, da das Ausgaberad sonst mehr als eine Karten mitziehen würde. \\

\textbf{\large Ausgaberad}\\
...
\begin{wrapfigure}{r}{0.6\textwidth}
    \includegraphics[width=0.6\textwidth]{fig/mech/Klemmmechanissmus1.pdf}
    \caption{Konzept 1}
\end{wrapfigure}
...
\begin{itemize}
    \item \textbf{... Klemmmechanissmus}
\end{itemize}
\begin{wrapfigure}{r}{0.6\textwidth}
    \includegraphics[width=0.6\textwidth]{fig/mech/Klemmmechanissmus2.pdf}
    \caption{Konzept 1}
\end{wrapfigure}

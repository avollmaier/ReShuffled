...
\input{biber.tex}
\input{listings}
\subject{\includegraphics[scale=0.035]{fig/LogoWithoutBorder.pdf}}
...
\author{Hörmann Stefan \and Perl Nicolas \and Vollmaier Alois}
\date{Abgabedatum: 18.03.2020}
\publishers{

{Dipl-Ing. Dr. Gerhard Pretterhofer}\\ \vspace{0.2cm}
...
\begin{document}
    ...
    \tableofcontents
    \mainmatter
    \include{modules/mech}
    \include{modules/elektro}
    \include{modules/ainf}
    \include{appendix}
\end{document}

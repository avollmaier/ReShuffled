...
/**
 * For well formated printing of a byte array with {@link Logger}.<br>
 * <p>
 * The byte array is typically given to constructor in the following way:
 * <blockquote><pre style="font-weight:bold">
 * byte [] data = { -10, 65, 66, 0, 127, -1, -128 }; LOG.info(new
 * LogRecordDataHexDump(data), "Data Block");
 * </pre></blockquote>
 * <p>
 * If data could change, you should copy the byte array, otherwise only an error
 * message is printed out:</p>
 * <blockquote><pre style="font-weight:bold">
 * byte [] data = { -10, 65, 66, 0, 127, -1, -128 }; LOG.info(new
 * LogRecordDataHexDump(Arrays.copyOf(data, data.length), "Data Block"));
 * </pre></blockquote>
 * <p>
 * You can also take only a part of this data array.</p>
 * <blockquote><pre style="font-weight:bold">
 * byte [] data = { 0x41, 0x42, 0x43, 0x44, 0x45, 0x30, 0x31, 0x32, 0x33, 0x34
 * }; LOG.info(new LogRecordDataHexDump(data, 2, 5), "Part of Data Block");
 * </pre></blockquote>
 * <p>
 * This results in the following LOGGER output:</p>
 ...
 * </pre>
 * <p>
 * If you want to preserve offset position in LOGGER output, use the constructor
...
public class LogRecordDataHexDump implements LogRecordData {
     ...
     * Data array must not change in future! If data could change, make a copy
     * of the array<br>
    ...
    /**
     * Constructor which takes only a part of the data array with preserving the
     * start offset in output.<br>
     * Data array must not change in future! If data could change, make a copy
     * of the array<br>
     * For example by using {@link Arrays#copyOfRange(boolean[], int, int) }
     *

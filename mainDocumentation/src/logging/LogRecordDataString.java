 ...
 * <p>
 * In normal message string all control characters are translated into a human
 * readable format. So for example line-feeds ('\n') are printed out as
 * "&lt;10&gt;". When using a LogRecordDataString object for the message, all
 * control sequences are written out as they are, for example a line-feed ('\n')
